	...
	var d = {},
		...
		t = l.Base = {
			extend : function(a) {
				s.prototype = this;
				var c = new s;
				a && c.mixIn(a);c.hasOwnProperty("init") || (c.init = function() {
		...
		v = w.Hex = {
			stringify : function(a) {
				...
				for (var e = [], j = 0; j < a; j++) {
					...
					e.push((k >>> 4).toString(16));e.push((k & 15).toString(16))
				}
				return e.join("")
			},
			parse : function(a) {
		...
		q = l.BufferedBlockAlgorithm = t.extend({
			...
			_append : function(a) {
				"string" == typeof a && (a = x.parse(a));this._data.concat(a);
...
(function(u) {
	...
	r = r.MD5 = v.extend({
		...
		_doFinalize : function() {
			...
			b.sigBytes = 4 * (n.length + 1);this._process();
			b = this._hash;
			n = b.words;
		...
		s = p.EvpKDF = d.extend({
			...
			compute : function(d, r) {
				for (var p = this.cfg, s = p.hasher.create(), b = l.create(), u = b.words, q = p.keySize, p = p.iterations; u.length < q;) {
					n && s.update(n);var n = s.update(d).finalize(r);
					s.reset();
...
CryptoJS.lib.Cipher || function(u) {
	...
	q.Encryptor = q.extend({
		processBlock : function(e, a) {
			var b = this._cipher,
				c = b.blockSize;
			x.call(this, e, a, c);b.encryptBlock(e, a);
	...
	q.Decryptor = q.extend({
		processBlock : function(e, a) {
			var b = this._cipher,
				c = b.blockSize,
				d = e.slice(a, a + c);
			b.decryptBlock(e, a);x.call(this,
				e, a, c);
			this._prevBlock = d
		}
	});
	...
	var n = d.CipherParams = l.extend({
		...
		b = (p.format = {}).OpenSSL = {
			stringify : function(a) {
				var b = a.ciphertext;
				a = a.salt;return (a ? s.create([ 1398893684,
		...
		c = d.PasswordBasedCipher = a.extend({
			...
			encrypt : function(b, c, d, l) {
				...
				d = l.kdf.execute(d,
					b.keySize, b.ivSize);
				l.iv = d.iv;
				b = a.encrypt.call(this, b, c, d.key, l);b.mixIn(d);return b
			},
	...
	var H = [ 0, 1, 2, 4, 8,
		...
		d = d.AES = p.extend({
			...
			decryptBlock : function(a, c) {
				var d = a[c + 1];
				a[c + 1] = a[c + 3];
				a[c + 3] = d;this._doCryptBlock(a, c, this._invKeySchedule, b, x, q, n, s);
				d = a[c + 1];
				a[c + 1] = a[c + 3];
				a[c + 3] = d
			},
...
var iv = CryptoJS.enc.Utf8.parse("easy-work-source"); //加密向量
