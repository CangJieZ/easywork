...
public class DateTimeUtil {
	 ...
	 * @Date:2017年2月16日下午1:12:26
	 * @return yyyy-MM-dd
	 * @return java.util.Date
	 * @throws ParseException
	 * @说明 代码版权归
	 */
	public static java.util.Date getCurrDateYmd() throws ParseException {
		return getFormatDateTime(getCurrDateStr(), DATE_FORMAT);
	}
	 ...
	 */
	public static Date formatStartTime(String datestring)  {
		String string = "";
		if ((datestring == null) || datestring.equals("")) {
			return null;
		}
	 ...
	 * @return int
	 */
	public static int getAgeByBirthTime(Date birthDate, Date currDate){
		int c  = compareDay(birthDate,currDate);
		return (c/365);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(getFormatDate(getDateBeforeOrAfter(-1)));

		System.out.println(addDateEndfix(getFormatDate(getCurrDate())));

		System.out
				.println(convertDecTime2Binary("0000000000,1073741823,4290772992"));

		System.out.println(plusDay(2000));
	}
